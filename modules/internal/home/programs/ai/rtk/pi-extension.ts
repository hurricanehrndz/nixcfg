...
//
// Vendored from `rtk init --agent pi` (rtk 0.42.3). Pi auto-loads any
// extension under ~/.pi/agent/extensions/, so dropping this file in place is
// all that is needed. Regenerate with `rtk init -g --auto-patch --agent pi`.
//
