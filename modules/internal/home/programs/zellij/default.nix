...
in
{
  config = l.mkIf cfg.cli.enable {
    programs.zellij = {
      ...
      # multiplexer here, so zellij is invoked explicitly with `zellij`.
      ...
      # (matching tmux); navigation is vim-style.
      extraConfig = ''
        ...
        // Plugin aliases - changing these requires a restart to take effect.
        plugins {
